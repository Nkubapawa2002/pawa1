...
(function () {
  ...
  var DB_SAYS = [
    ...
    [/reaches at most/i, "pm_err_castcap", "An announcement you send reaches at most {n} people."],
    [/nobody in that scope has set up p-message/i, "pm_err_scope_nokeys",
     "Nobody in that group has opened P-Message yet, so there is nobody an announcement could be encrypted to."],
    [/that person has not set up p-message/i, "pm_err_peer_nokey",
     "They have not opened P-Message yet, so there is no key to encrypt to. Send them an invite."],
    [/only the room owner/i, "pm_err_notowner",
     "Only whoever opened the room can add or remove people."],
    [/cannot start a conversation with that person/i, "pm_err_nostart",
     "You cannot start a conversation with that person."],
    [/too long to send/i, "pm_err_toolong", "That is too long to send. Shorten it and try again."],
