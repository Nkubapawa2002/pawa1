...
//
// Usage (PowerShell):
//   $env:SUPABASE_SERVICE_ROLE="<service_role_key>"; node scripts/upload/upload_data_photos.mjs
// Usage (bash):
//   SUPABASE_SERVICE_ROLE=<service_role_key> node scripts/upload/upload_data_photos.mjs
