...
--
-- Mirrors public.trucks (supabase/features/truck/trucks.sql): public read, owner writes
...
-- hidden from clients (see supabase/features/agent/agent_subscription.sql + agent_grace_active.sql).
--
