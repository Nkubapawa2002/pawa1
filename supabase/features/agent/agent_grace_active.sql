...
--
-- Extends supabase/features/agent/agent_subscription.sql with two admin-controlled rules:
--
...
--
-- Depends on: supabase/features/agent/agent_billing.sql, supabase/features/agent/agent_subscription.sql
