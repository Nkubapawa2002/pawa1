...
--
-- Idempotent. Safe to re-run. Depends on supabase/features/house/setup_house_demand.sql and
-- supabase/features/house/house_demand_needed_by.sql. Paste into the Supabase SQL editor, Run.
-- ============================================================================
begin;
